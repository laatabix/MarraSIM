# I-Maroc Project
**I-Maroc** (***I**ntelligence artificielle/**M**athématiques **A**ppliquées, santé/envi**RO**nnement: simulation pour l’aide à la dé**C**ision*) is project that aims to design and implement computer simulations for health and environment by means of advanced artificial intelligence, data analysis, and mathematical tools. In the workpackage 3 (Urban and inter-urban mobility), we work on modeling multiple aspects of road traffic in Marrakesh to propose solutions and scenarios in order to improve mobility and reduce pollution and congestion.
